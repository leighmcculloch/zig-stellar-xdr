...
/// Generator for producing Zig code from XDR specs.
...
pub struct StructOutput {
    ...
    /// Comma-separated list of member names for destructuring
...
pub struct ConstOutput {
    /// The const name (SCREAMING_SNAKE_CASE).
    pub name: String,
